...
import { VaultPath, ValidatedPath, getAt, getDirectoryAt } from "../src/controller.js"; // Type
import { File, Directory } from "../src/vfs.js"; // Type
import { Stats } from "fs"; // Type

const { createNewVault, deleteVault } = await import("../src/vault.js");
const { validate } = await import("../src/controller.js");
const { getTempFile, addFile, addFolder, copyItem, moveItem, deleteItem } = await import("../src/file.js");
const { BASE_VAULT_DIRECTORY } = await import("../src/env.js");
