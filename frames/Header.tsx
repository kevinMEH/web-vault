...
const Header = ({ vaultName }: HeaderParameters) => {
    ...
    return <header className="flex h-14 bg-white border-b border-gray justify-between flex-shrink-0 items-center">
        ...
        <div className="w-full flex items-center justify-end">
            ...
            <div className="font-inter text-quiet ml-5 mx-20 pt-[1px] text-ellipsis whitespace-nowrap">Search for items</div>
        </div>
        <div className="border-r border-gray h-8" />
        <div className="flex items-center justify-center space-x-3 w-[349px] shrink-0">
